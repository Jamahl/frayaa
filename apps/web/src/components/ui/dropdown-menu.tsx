...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={[
        "dropdown-menu-item",
        variant === "destructive" ? "dropdown-menu-item--destructive" : null,
        inset ? "dropdown-menu-item--inset" : null,
        className
      ].filter(Boolean).join(" ")}
      {...props}
    />
    ...
    >
      <span className="pointer-events-none absolute left-2 flex size-3.5 items-center justify-center">
        <DropdownMenuPrimitive.ItemIndicator>
          <CheckIcon className="dropdown-menu-checkbox-icon" />
        </DropdownMenuPrimitive.ItemIndicator>
      </span>
      {children}
    </DropdownMenuPrimitive.CheckboxItem>
...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      className={[
        "dropdown-menu-label",
        inset ? "dropdown-menu-label--inset" : null,
        className
      ].filter(Boolean).join(" ")}
      {...props}
    />
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      className={[
        ...
        inset ? "dropdown-menu-sub-trigger--inset" : null,
        className
      ].filter(Boolean).join(" ")}
      {...props}
    >
